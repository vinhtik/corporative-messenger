    ...
    <Dialog open = {openNewContactModal} onOpenChange={setOpenNewContactModal}>
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
            ...
            </div>
            {
                ...
                />
                <div className="text-opaciy-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-200 text-center">
                  <h3 className="poppins-medium">
                    Здесь пока нет
                    <span className="text-green-500"> Контактов.</span>
                  </h3>
                </div>
            </div>
            }
