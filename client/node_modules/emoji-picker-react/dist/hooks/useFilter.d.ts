...
export declare function filterEmojiObjectByKeyword(emojis: FilterDict, keyword: string): FilterDict;
export declare function useIsEmojiFiltered(): (unified: string) => boolean;
export declare function isEmojiFilteredBySearchTerm(unified: string, filter: FilterState, searchTerm: string): boolean;
export declare type FilterDict = Record<string, DataEmoji>;
export declare function findLongestMatch(keyword: string, dict: Record<string, FilterDict> | null): FilterDict | null;
