...
export declare function useSearchClearButtonLabelConfig(): string;
...
export declare function useCategoryIconsConfig(): Partial<Record<import("./categoryConfig").Categories, React.ReactNode>>;
